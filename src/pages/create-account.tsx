...
export default function CreateAccount() {
  const [create, {loading, data }] = useMutation<CreateMutationResult>({method: "POST"})
  const {
    register,
    handleSubmit,
    setError,
  ...
  return (
    <div>
      ...
      <div className="flex p-10 px-0 lg:p-20 flex-col justify-center items-center h-full w-full m-auto">
        ...
        <form
          ...
          className="w-full flex flex-col items-center space-y-4 pt-6"
        >
          <Input
            type="email"
            placeholder="(필수) 이메일*"
            ...
            register={register("email",
              ...
              width="w-4/5 sm:w-2/5 2xl:w-1/5"
          />
          ...
          <Input
            ...
            width="w-4/5 sm:w-2/5 2xl:w-1/5 "
          />
          <Button text={isSubmitting ? "가입 중..." : "가입하기"} width="w-4/5 sm:w-2/5 2xl:w-1/5" />
